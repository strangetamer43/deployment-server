...
import { createQuiz, editQUiz, getAllQuizOfUser, getQuizById, getAllQuizs, getQuizBySearchForUser, getQuizBySearch, getQuizsOfUserLazyLoading, getQuizsLazyLoading } from "../controllers/Challenges.js";
import { submitResponse, getResponsesByUser, getResponse, getResponseByQuizId, submittingQuiz, getAllResponse, getResponseByUserName, createResponse, getResponseLazyLoading } from "../controllers/Response.js";
...
router.post("/getResponseByPage", getResponseLazyLoading);
router.post("/getQuizOfUserByPage", getQuizsOfUserLazyLoading);
router.post("/getQuizByPage", getQuizsLazyLoading);
